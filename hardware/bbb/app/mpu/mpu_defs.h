...
#define WHO_AM_I_MPU9250_RESULT 0x71
 ...
 *******************************************************************/
constexpr uint8_t FIFO_MODE_REPLACE_OLD = 0x00 << 6;
constexpr uint8_t FIFO_MODE_KEEP_OLD = 0x01 << 6;
...
constexpr uint8_t GYRO_FSR_CFG_250 = 0x00 << 3;
constexpr uint8_t GYRO_FSR_CFG_500 = 0x01 << 3;
constexpr uint8_t GYRO_FSR_CFG_1000 = 0x02 << 3;
constexpr uint8_t GYRO_FSR_CFG_2000 = 0x03 << 3;
constexpr uint8_t FCHOICE_B_DLPF_EN = 0x00;
constexpr uint8_t FCHOICE_B_DLPF_DISABLE = 0x01;
...
constexpr uint8_t ACCEL_FSR_CFG_2G = 0x00 << 3;
constexpr uint8_t ACCEL_FSR_CFG_4G = 0x01 << 3;
constexpr uint8_t ACCEL_FSR_CFG_8G = 0x02 << 3;
constexpr uint8_t ACCEL_FSR_CFG_16G = 0x03 << 3;
...
#define WHO_AM_I_AK8963_VALUE 0x48
#define INFO 0x01
