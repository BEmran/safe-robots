 ...
 *
 * The traditional usleep function, however common, is deprecated in linux as
 it
 * uses SIGALARM which interferes with alarm and timer functions. This uses
 the
 ...
 * restarting nanosleep with the remaining time in the event that nanosleep
 is
...
//  * CLOCK_REALTIME
//  *
//  * This function itself takes about 1100ns to complete on a beaglebone at
//  1ghz
...
//  * CLOCK_MONOTONIC
//  *
//  * This function itself takes about 1100ns to complete on a bealgebone at
//  1ghz
//  * under ideal circumstances.
//  *
...
//  * execute. This function itself takes about 2100ns to complete on a
//  beaglebone
...
//  * Unlike timespec_sub defined in time.h, rc_timespec_diff does not care
//  which
