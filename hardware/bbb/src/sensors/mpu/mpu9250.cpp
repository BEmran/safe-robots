...
Mpu9250::Mpu9250(const Config& config, std::unique_ptr<bbb::SPI> comm,
...
void Mpu9250::Reset() const {
  ...
  bbb::hardware_utils::Delay(LongDelay);
  ...
  bbb::hardware_utils::Delay(ShortDelay);
