...
class MPU9250 : public MPUIMU
{
 ...
 protected:
  MPU9250(Ascale_t ascale, Gscale_t gscale, Mscale_t mscale, Mmode_t mmode,
  ...
  virtual void readAccelOffsets(uint8_t data[12],
                                int32_t accel_bias_reg[3]) override;

  virtual void writeAK8963Register(uint8_t subAddress, uint8_t data) = 0;

  virtual void readAK8963Registers(uint8_t subAddress, uint8_t count,
                                   uint8_t* dest) = 0;
