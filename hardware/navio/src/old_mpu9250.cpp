...
OLD_MPU9250::OLD_MPU9250() : core::sensors::ImuSensorModule("old", false)
{
}
...
unsigned int OLD_MPU9250::ReadReg(uint8_t ReadAddr)
{
...
void OLD_MPU9250::ReadRegs(uint8_t ReadAddr, uint8_t *ReadBuf, unsigned int Bytes)
{
    unsigned int  i = 0;
...
unsigned int OLD_MPU9250::set_acc_scale(int scale)
{
    ...
    printf("set_acc_scale %u -> %u acc_divider %f\n", scale, temp_scale, acc_divider);
    return temp_scale;
}
...
unsigned int OLD_MPU9250::set_gyro_scale(int scale)
{
    unsigned int temp_scale;
    ...
    printf("set_gyro_scale %u -> %u gyro_divider %f\n", scale, temp_scale, gyro_divider);
    return temp_scale;
}
