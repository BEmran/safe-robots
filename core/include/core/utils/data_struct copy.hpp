...
struct DataStruct : public DataStructInterface {
 public:
  ...
  // virtual void Clear() override {data_ = T{}}
  // virtual std::string Header() const override {return label;}
  // virtual std::string ToString() const override {return ;
  void Set(DataStructInterface* dsi_ptr) override {
    if (auto ds = dynamic_cast<DataStruct<T, LABEL>*>(dsi_ptr); ds != nullptr) {
...
//   static const auto header = label_ + ":x, " + label_ + ":y, " + label_ +
//   ":z"; return header;
// }
