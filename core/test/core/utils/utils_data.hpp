...
ExpectDoubleDataEq(const DoubleData& expect, const DoubleData& actual);
 ...
 * @return ::testing::AssertionResult assentation result
 */
[[nodiscard]] ::testing::AssertionResult ExpectVec3Eq(const Vec3& expect,
                                                      const Vec3& actual);
 ...
 */
[[nodiscard]] ::testing::AssertionResult
ExpectVec3DataEq(const Vec3Data& expect, const Vec3Data& actual);
 ...
 * @return ::testing::AssertionResult assentation result
 */
[[nodiscard]] ::testing::AssertionResult ExpectQuatEq(const Quat& expect,
                                                      const Quat& actual);
 ...
 */
[[nodiscard]] ::testing::AssertionResult
ExpectQuatDataEq(const QuatData& expect, const QuatData& actual);
 ...
 * @return ::testing::AssertionResult assentation result
 */
[[nodiscard]] ::testing::AssertionResult ExpectImuData(const ImuData& expect,
 ...
 * @return ::testing::AssertionResult assentation result
 */
[[nodiscard]] ::testing::AssertionResult ExpectGPSData(const GpsData& expect,
